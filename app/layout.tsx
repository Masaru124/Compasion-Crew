...
export const metadata: Metadata = {
  ...
  description:
    "COMPASSION CREW is Bangalore's leading social impact community. Join expert talks, volunteer drives, and networking events to learn, connect, and make a lasting difference. 80G tax-deductible donations.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Bangalore's social impact community. Join expert talks, volunteer drives, and networking events. Make a real difference — 80G tax-deductible donations.",
    images: [
      {
